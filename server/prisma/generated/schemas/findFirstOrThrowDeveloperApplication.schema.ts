...
export const DeveloperApplicationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DeveloperApplicationSelect> = z.object({
...
export const DeveloperApplicationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    telegram: z.boolean().optional(),
    productName: z.boolean().optional(),
    productDescription: z.boolean().optional(),
...
export const DeveloperApplicationFindFirstOrThrowSchema: z.ZodType<Prisma.DeveloperApplicationFindFirstOrThrowArgs> = z.object({ select: DeveloperApplicationFindFirstOrThrowSelectSchema.optional(), include: DeveloperApplicationIncludeObjectSchema.optional(), orderBy: z.union([DeveloperApplicationOrderByWithRelationInputObjectSchema, DeveloperApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeveloperApplicationWhereInputObjectSchema.optional(), cursor: DeveloperApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeveloperApplicationScalarFieldEnumSchema, DeveloperApplicationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeveloperApplicationFindFirstOrThrowArgs>;

export const DeveloperApplicationFindFirstOrThrowZodSchema = z.object({ select: DeveloperApplicationFindFirstOrThrowSelectSchema.optional(), include: DeveloperApplicationIncludeObjectSchema.optional(), orderBy: z.union([DeveloperApplicationOrderByWithRelationInputObjectSchema, DeveloperApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeveloperApplicationWhereInputObjectSchema.optional(), cursor: DeveloperApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeveloperApplicationScalarFieldEnumSchema, DeveloperApplicationScalarFieldEnumSchema.array()]).optional() }).strict();