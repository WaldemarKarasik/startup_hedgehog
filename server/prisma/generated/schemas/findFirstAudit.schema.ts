...
export const AuditFindFirstSelectSchema: z.ZodType<Prisma.AuditSelect> = z.object({
...
export const AuditFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dealId: z.boolean().optional(),
    userId: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AuditFindFirstSchema: z.ZodType<Prisma.AuditFindFirstArgs> = z.object({ select: AuditFindFirstSelectSchema.optional(),  orderBy: z.union([AuditOrderByWithRelationInputObjectSchema, AuditOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuditWhereInputObjectSchema.optional(), cursor: AuditWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuditScalarFieldEnumSchema, AuditScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AuditFindFirstArgs>;

export const AuditFindFirstZodSchema = z.object({ select: AuditFindFirstSelectSchema.optional(),  orderBy: z.union([AuditOrderByWithRelationInputObjectSchema, AuditOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuditWhereInputObjectSchema.optional(), cursor: AuditWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuditScalarFieldEnumSchema, AuditScalarFieldEnumSchema.array()]).optional() }).strict();