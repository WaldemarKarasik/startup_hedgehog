...
export const DealFindFirstSelectSchema: z.ZodType<Prisma.DealSelect> = z.object({
...
export const DealFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    product: z.boolean().optional(),
    buyerId: z.boolean().optional(),
...
export const DealFindFirstSchema: z.ZodType<Prisma.DealFindFirstArgs> = z.object({ select: DealFindFirstSelectSchema.optional(), include: DealIncludeObjectSchema.optional(), orderBy: z.union([DealOrderByWithRelationInputObjectSchema, DealOrderByWithRelationInputObjectSchema.array()]).optional(), where: DealWhereInputObjectSchema.optional(), cursor: DealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DealScalarFieldEnumSchema, DealScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DealFindFirstArgs>;

export const DealFindFirstZodSchema = z.object({ select: DealFindFirstSelectSchema.optional(), include: DealIncludeObjectSchema.optional(), orderBy: z.union([DealOrderByWithRelationInputObjectSchema, DealOrderByWithRelationInputObjectSchema.array()]).optional(), where: DealWhereInputObjectSchema.optional(), cursor: DealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DealScalarFieldEnumSchema, DealScalarFieldEnumSchema.array()]).optional() }).strict();