...
const makeSchema = () => z.object({
  ...
  deals: z.lazy(() => DealUncheckedCreateNestedManyWithoutProductInputObjectSchema).optional(),
  reviews: z.lazy(() => ReviewUncheckedCreateNestedManyWithoutProductInputObjectSchema).optional()
}).strict();
export const ProductUncheckedCreateWithoutDeveloperInputObjectSchema: z.ZodType<Prisma.ProductUncheckedCreateWithoutDeveloperInput> = makeSchema() as unknown as z.ZodType<Prisma.ProductUncheckedCreateWithoutDeveloperInput>;
export const ProductUncheckedCreateWithoutDeveloperInputObjectZodSchema = makeSchema();
