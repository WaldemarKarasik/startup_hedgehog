...
import { ReviewCreateNestedManyWithoutAuthorInputObjectSchema as ReviewCreateNestedManyWithoutAuthorInputObjectSchema } from './ReviewCreateNestedManyWithoutAuthorInput.schema';
...
const makeSchema = () => z.object({
  ...
  developedProducts: z.lazy(() => ProductCreateNestedManyWithoutDeveloperInputObjectSchema),
  purchasedDeals: z.lazy(() => DealCreateNestedManyWithoutBuyerInputObjectSchema),
  soldDeals: z.lazy(() => DealCreateNestedManyWithoutDeveloperInputObjectSchema),
  reviews: z.lazy(() => ReviewCreateNestedManyWithoutAuthorInputObjectSchema),
  receivedReviews: z.lazy(() => ReviewCreateNestedManyWithoutTargetUserInputObjectSchema),
  disputes: z.lazy(() => DisputeCreateNestedManyWithoutInitiatorInputObjectSchema),
  notifications: z.lazy(() => NotificationCreateNestedManyWithoutUserInputObjectSchema)
}).strict();
