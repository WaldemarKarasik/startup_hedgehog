...
export const DeveloperApplicationFindFirstSelectSchema: z.ZodType<Prisma.DeveloperApplicationSelect> = z.object({
...
export const DeveloperApplicationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    telegram: z.boolean().optional(),
    productName: z.boolean().optional(),
    productDescription: z.boolean().optional(),
...
export const DeveloperApplicationFindFirstSchema: z.ZodType<Prisma.DeveloperApplicationFindFirstArgs> = z.object({ select: DeveloperApplicationFindFirstSelectSchema.optional(), include: DeveloperApplicationIncludeObjectSchema.optional(), orderBy: z.union([DeveloperApplicationOrderByWithRelationInputObjectSchema, DeveloperApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeveloperApplicationWhereInputObjectSchema.optional(), cursor: DeveloperApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeveloperApplicationScalarFieldEnumSchema, DeveloperApplicationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeveloperApplicationFindFirstArgs>;

export const DeveloperApplicationFindFirstZodSchema = z.object({ select: DeveloperApplicationFindFirstSelectSchema.optional(), include: DeveloperApplicationIncludeObjectSchema.optional(), orderBy: z.union([DeveloperApplicationOrderByWithRelationInputObjectSchema, DeveloperApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeveloperApplicationWhereInputObjectSchema.optional(), cursor: DeveloperApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeveloperApplicationScalarFieldEnumSchema, DeveloperApplicationScalarFieldEnumSchema.array()]).optional() }).strict();