...
export const DealFindManySelectSchema: z.ZodType<Prisma.DealSelect> = z.object({
...
export const DealFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    product: z.boolean().optional(),
    buyerId: z.boolean().optional(),
...
export const DealFindManySchema: z.ZodType<Prisma.DealFindManyArgs> = z.object({ select: DealFindManySelectSchema.optional(), include: DealIncludeObjectSchema.optional(), orderBy: z.union([DealOrderByWithRelationInputObjectSchema, DealOrderByWithRelationInputObjectSchema.array()]).optional(), where: DealWhereInputObjectSchema.optional(), cursor: DealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DealScalarFieldEnumSchema, DealScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DealFindManyArgs>;

export const DealFindManyZodSchema = z.object({ select: DealFindManySelectSchema.optional(), include: DealIncludeObjectSchema.optional(), orderBy: z.union([DealOrderByWithRelationInputObjectSchema, DealOrderByWithRelationInputObjectSchema.array()]).optional(), where: DealWhereInputObjectSchema.optional(), cursor: DealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DealScalarFieldEnumSchema, DealScalarFieldEnumSchema.array()]).optional() }).strict();