...
export const AuditFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AuditSelect> = z.object({
...
export const AuditFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    dealId: z.boolean().optional(),
    userId: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AuditFindFirstOrThrowSchema: z.ZodType<Prisma.AuditFindFirstOrThrowArgs> = z.object({ select: AuditFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([AuditOrderByWithRelationInputObjectSchema, AuditOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuditWhereInputObjectSchema.optional(), cursor: AuditWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuditScalarFieldEnumSchema, AuditScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AuditFindFirstOrThrowArgs>;

export const AuditFindFirstOrThrowZodSchema = z.object({ select: AuditFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([AuditOrderByWithRelationInputObjectSchema, AuditOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuditWhereInputObjectSchema.optional(), cursor: AuditWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuditScalarFieldEnumSchema, AuditScalarFieldEnumSchema.array()]).optional() }).strict();